...
/** Utility type to add an 'id' field and the raw document to a given type T. */
export type WithId<T> = T & { id: string; _raw?: DocumentData };
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot: QuerySnapshot<DocumentData>) => {
        ...
        for (const doc of snapshot.docs) {
          results.push({ ...(doc.data() as T), id: doc.id, _raw: doc });
        }
        setData(results);
        setError(null);
        setIsLoading(false);
