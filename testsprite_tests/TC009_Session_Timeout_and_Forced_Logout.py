...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click Sign in to log in as the user.
        ...
        # -> Retry login with provided credentials to ensure session starts properly.
        frame = context.pages[-1]
        ...
        # -> Try clearing the email and password fields and re-entering the credentials carefully, then attempt login again.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test failed: User session did not expire after inactivity timeout as expected, and user was not redirected to the login page.')
