...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Forgot password?' link to attempt password recovery or reset.
        frame = context.pages[-1]
        ...
        # -> Input company email and click 'Send reset link' to initiate password reset process.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test case failed: Payment recording, tracking, and linking with related sales and finance records did not succeed as per the test plan.')
